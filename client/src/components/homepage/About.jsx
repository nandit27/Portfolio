...
import profileImg from "/src/assets/images/hero.jpeg";
      ...
      <div className="mt-10 flex flex-col items-start gap-8 md:flex-row lg:gap-10 ">
        <div className="top-28 overflow-hidden rounded-md md:sticky md:w-1/2">
          <img
            ...
            width="600"
            height="800"
            alt="portrait image of Nandit posing at an event"
          />
        </div>
        <div className="top-20 sm:sticky md:top-28 lg:top-32 md:w-1/2">
          <div className="w-full space-y-4 2xl:space-y-10">
            ...
            <p ref={body} className=" translate-y-10 text-body-1 2xl:text-4xl opacity-0">
              I am a builder, a creator and love to turn ideas to reality. 
              <br></br>
              ...
              Interested in Artificial Intelligence, MERN Stack & working with LLMs to 
              my advantage. I love to build anything and everything, just give me an idea. 
            </p>
          </div>
        </div>
      </div>

...
export default function NavBar({ sectionRefs, color }) {
  ...
  return (
    <>
      ...
      >
        {/* logo */}
        <Link to="/" aria-label="Logo" className="z-50 flex items-center justify-center">
          <span 
            ref={logo} 
            className="font-general text-2xl font-black tracking-widest uppercase inline-block"
            style={{ color: color || '#0E0E0C' }}
          >
            NANDIT
          </span>
        </Link>

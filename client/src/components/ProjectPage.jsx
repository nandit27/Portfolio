      ...
      <div className="min-h-screen bg-accent-400 text-secondary-400 pb-16">
        ...
        <AnimatedSection delay={100}>
          <div className="max-w-6xl mx-auto px-8">
            <a href={project.liveUrl || project.link || '#'} target="_blank" rel="noopener noreferrer" className="block w-full h-full">
              <figure className="img overflow-hidden rounded-2xl border border-secondary-400/20 hover:scale-[1.01] transition-transform duration-500 cursor-none">
                <img
                  src={project.image}
          ...
          <div className="flex justify-center gap-4 flex-wrap max-w-4xl mx-auto my-12 px-8">
            {(project.liveUrl || project.link) && (
              <a
                ...
                className="img inline-flex items-center gap-2 px-8 py-4 rounded-full font-medium text-base bg-gradient-to-r from-indigo-500 to-purple-500 text-white hover:-translate-y-0.5 hover:shadow-lg hover:shadow-indigo-500/30 transition-all cursor-none"
              >
            ...
            {project.sourceUrl && (
              <a
                ...
                rel="noopener noreferrer"
                data-cursor-size="70px"
                className="img inline-flex items-center gap-2 px-8 py-4 rounded-full font-medium text-base bg-transparent text-secondary-400 border border-secondary-400/30 hover:bg-secondary-400 hover:text-accent-400 hover:border-secondary-400/80 transition-all cursor-none"
              >
